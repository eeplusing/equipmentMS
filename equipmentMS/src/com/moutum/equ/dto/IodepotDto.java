...
/************************************************************************************
 * @Title        : IodepotDto.java
 * @Description : 
 * @Author       : BianWeiqing
 * @DateTime     : 2015年4月22日 上午11:14:51
 * @Copyright    : 2015 Moutum All Rights Reserved
 * @version      : V1.0
 ************************************************************************************/
public class IodepotDto
{
private long iodepotId;//信息编号
    ...
    private String iodepotTime;//时间(yyyy-MM-dd HH:mm:ss)
    ...
    public String getIodepotTime()
    {
        return iodepotTime;
    }

    public void setIodepotTime(String iodepotTime)
    {
