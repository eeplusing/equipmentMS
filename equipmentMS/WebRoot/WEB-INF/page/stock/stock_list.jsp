...
<html>
  <head>
    ...
    <script type="text/javascript">
	     $(function(){
	         $('#bill').datagrid({
	             ...
	             columns:[[
	                 ...
	                 {field:'typeName',title:'备品名称',width:150,align:'center'},
	                 {field:'minamount',title:'安全库存量',width:150,align:'center'},
	                 {field:'amount',title:'库存量',width:150,align:'center'}
	             ]],
	             toolbar:[{
						      id:'btncut',  
							  text:'设置库存上下限', 
							  ...
							  handler:function(){
								  ...
								  if(selectedRow.length > 0){
								      move_open(selectedRow[0].typeId);
								  }else{
         ...
         function modify(){
             $.ajax({
			     url:"stock_modify.action",
				 type:"post", 
				 cache:false,
				 data:"typeId=" + $("#typeId").val() + "&minamount=" + $("#minamount").val(),
